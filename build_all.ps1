...
& (Join-Path $Root "build_d3_structural.ps1") -GurobiRoot $GurobiRoot
& (Join-Path $Root "build_interval_oracle.ps1")
& (Join-Path $Root "build_contract_ee_rmp.ps1") -GurobiRoot $GurobiRoot
& (Join-Path $Root "build_deep_structural.ps1") -GurobiRoot $GurobiRoot
