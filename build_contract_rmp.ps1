...
$CrCommand = '"' + $CrVcVars + '" >nul && cl /nologo /O2 /MD /EHsc /std:c++17 /LD /I"' + $GurobiRoot + '\include" /Fo"' + $CrOutput + '\contract_rmp.obj" "' + $CrRoot + '\native\contract_rmp.cpp" /link /LIBPATH:"' + $GurobiRoot + '\lib" gurobi_c++md2017.lib gurobi130.lib /OUT:"' + $CrOutput + '\contract_rmp.dll" /IMPLIB:"' + $CrOutput + '\contract_rmp.lib"'
